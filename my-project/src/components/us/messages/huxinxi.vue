...
<span>{{msg}}</span>
    ...
    <section class="f_hu_top">
        <div class="f_touxiang">
           ...
           <span>头像</span>
           <div>
               <img :src="'https://elm.cangdu.org/img/'+mes.avatar" alt="">
               <span class="el-icon-arrow-right"></span>
           </div> 
        </div>
    </section>
    <section class="f_name">
        <a href="#/profile/info/setusername" class="f_name_a">
            <span>用户名</span>
            <div>
    ...
    <section class="f_souhuo">
<a href="#/profile/info/address" class="f_souhuo_a">
    <span>
        收货地址
    </span>
    <span class="el-icon-arrow-right"></span>
    ...
    <div class="f_hu_center">
        账号绑定
    </div>

    <section class="f_shouji">
        <div  class="f_shouji_a" @click="bol=true">
                <div>
    ...
    <section class="f_mima">
        <a href="#/forget" class="f_a">
    ...
    <div class="f_button" @click="bol2=true">
        退出登录
    </div>

    <Elert v-if="bol2">
            <p>{{content2}}</p>
            <div class="f_alert_tuichu" >
                <button @click="bol2=false" >再等等</button>
...
.f_alert_tuichu>button:nth-child(1){
...
.f_alert_tuichu>button:nth-child(2){
